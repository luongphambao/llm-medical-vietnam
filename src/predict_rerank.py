...
def parse_args():
    ...
    parser.add_argument("--output_path", type=str, default="submit.csv", help="output path")
...
def main():
    ...
    question, choices, num_choices = process_single_row(df.iloc[index])
    print("question:",question)
    docs = search.hybrid_search(question)
    # print("docs:",docs)
    # print("question:",question)
    # docs_rerank = rerank.rerank(question,docs)
    # print("docs_rerank:",docs_rerank)
    # print("docs:",docs)
    context = search.get_context(docs)
    context_rerank = rerank.rerank(question,context)
    #print("context_rerank:",context_rerank)
